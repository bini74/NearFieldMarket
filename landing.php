...
<html lang="en">
  ...
  <body>
        ...
        <div class="modal fade" id="change_password" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="layouts/change_password/" method="POST">
            ...
            <div class="modal fade" id="avatar" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="layouts/change_avatar/" method="POST" enctype="multipart/form-data">
